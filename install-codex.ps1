...
| "이 논문 재현해줘" | ``$KitDir\.claude\skills\potato-reproduce\SKILL.md`` |
| "최적화", "스케줄 짜줘" | ``$KitDir\.claude\skills\potato-optimize\SKILL.md`` |
| "보고서 써줘", "결과 정리" | ``$KitDir\.claude\skills\potato-report\SKILL.md`` |
| "발표자료", "PPT" | ``$KitDir\.claude\skills\potato-slides\SKILL.md`` |
| "제출 파일", 경진대회 | ``$KitDir\.claude\skills\potato-submit\SKILL.md`` |
| "팩 켜줘", "무슨 팩 있어" | ``$KitDir\.claude\skills\potato-add-pack\SKILL.md`` |
