...
- 08-06: `/eda` — Ticket 중복 210건, train-test 걸침 115건 탐지
- 08-06: `/experiment` v1 — 4모델 비교, GroupKFold로 누수 측정
- 08-06: `methods-reviewer` 감사 → **fail**. major 3 / minor 7 / info 5
- 08-06: v2 재실험 — StratifiedGroupKFold + 5시드. 누수 재측정 −0.0219
- 08-06: `/report` → md, `/slides` → 9장 pptx
- 08-07: `/submit` 제출파일 검증 6항목 통과
- 08-07: `/optimize` CP-SAT 근무표 + 민감도, `/find-data` 공공데이터 수집
